...
@org.kie.kogito.codegen.Generated(value = "kogito-codegen", reference = "approval", name = "Approval", hidden = false)
public class ApprovalModel implements org.kie.kogito.Model, MapInput, MapInputId, MapOutput, MappableToModel<ApprovalModelOutput> {
    ...
    @Override()
    public ApprovalModelOutput toModel() {
        ApprovalModelOutput result = new ApprovalModelOutput();
        result.setId(getId());
